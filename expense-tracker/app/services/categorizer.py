...
SEED_RULES = [
    ...
    # NZ supermarkets / groceries
    ("countdown",            "Groceries",            "contains"),
    ("new world",            "Groceries",            "contains"),
    ("pak n save",           "Groceries",            "contains"),
    ("paknsave",             "Groceries",            "contains"),
    ("four square",          "Groceries",            "contains"),
    ("fresh choice",         "Groceries",            "contains"),
    ("supervalue",           "Groceries",            "contains"),
    ("moore wilson",         "Groceries",            "contains"),
    # NZ fuel
    ("z energy",             "Fuel",                 "contains"),
    ("gull petroleum",       "Fuel",                 "contains"),
    ("mobil",                "Fuel",                 "contains"),
    ("bp ",                  "Fuel",                 "contains"),
    ("caltex",               "Fuel",                 "contains"),
    ("allied petroleum",     "Fuel",                 "contains"),
    # Software/Cloud (internationally used)
    ...
    ("xero",                 "Software & SaaS",      "contains"),
    ("myob",                 "Software & SaaS",      "contains"),
    # Subscriptions
    ...
    # NZ travel
    ("air new zealand",      "Travel",               "contains"),
    ("jetstar",              "Travel",               "contains"),
    ("qantas",               "Travel",               "contains"),
    ("uber",                 "Travel",               "contains"),
    ("ola cabs",             "Travel",               "contains"),
    ("airbnb",               "Travel",               "contains"),
    ("booking.com",          "Travel",               "contains"),
    ("at hop",               "Travel",               "contains"),
    ("metlink",              "Travel",               "contains"),
    # NZ meals / delivery
    ("uber eats",            "Meals & Entertainment","contains"),
    ("menulog",              "Meals & Entertainment","contains"),
    ("doordash",             "Meals & Entertainment","contains"),
    ("hell pizza",           "Meals & Entertainment","contains"),
    # NZ office supplies
    ("warehouse stationery", "Office Supplies",      "contains"),
    ("officemax",            "Office Supplies",      "contains"),
    ("pb tech",              "Office Supplies",      "contains"),
    # NZ government / tax
    ("ird",                  "Taxes & Fees",         "contains"),
    ("inland revenue",       "Taxes & Fees",         "contains"),
    ("companies office",     "Professional Services","contains"),
    ("acc ",                 "Taxes & Fees",         "contains"),
    # NZ utilities / telcos
    ("spark",                "Utilities",            "contains"),
    ("vodafone nz",          "Utilities",            "contains"),
    ("2degrees",             "Utilities",            "contains"),
    ("one nz",               "Utilities",            "contains"),
    ("contact energy",       "Utilities",            "contains"),
    ("genesis energy",       "Utilities",            "contains"),
    ("mercury energy",       "Utilities",            "contains"),
    ("meridian energy",      "Utilities",            "contains"),
    ("vector",               "Utilities",            "contains"),
    ("slingshot",            "Utilities",            "contains"),
    ("chorus",               "Utilities",            "contains"),
]
